 ...
 *    System.end.println(gv.getDotSource());
 *
 *    String type = "gif";
 *    String representationType="dot";
 *    File end = new File("end." + type);   // end.gif in this example
 *    gv.writeGraphToFile( gv.getGraph(gv.getDotSource(), type, representationType), end );
 * </pre>
 * </dd>
 *
 * </dl>
...
public class GraphViz
{
     ...
     */
    public GraphViz() {
        if (GraphViz.osName.equals("Windows")) {
            this.tempDir = "c:/temp";
